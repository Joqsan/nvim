...
vim.keymap.set('n', '<leader>gs', builtin.grep_string, {desc = "[Telescope]: Search string under cursor in cwd"})
vim.keymap.set(
	'n',
	'<leader>tr',
	function()
...
vim.keymap.set('n', '<leader>tc', builtin.lsp_document_symbols, {desc = "[Telescope]: list LSP document symbols in the current buffer"})
